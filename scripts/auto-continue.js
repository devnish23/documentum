...
module.exports = AutoContinue;

// CLI usage
if (require.main === module) {
  const executor = new AutoContinue();
  ...
  if (command === 'workflow') {
    ...
    console.log('Usage: node auto-continue.js [workflow|npm|git|python|playwright]');
  }
} 